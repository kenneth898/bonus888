	...
	<div class="container-fluid">
		<div class="col-12">
			<div class="row">
				...
				<div style="padding: 0px;" class="col-sm-12 col-md-6 mobile_col2 center_col">
					<!--main-->
					...
					<div class="content" :id="menuItems[activeIndex].componentId">
						<Content />
					</div>
				</div>
...
<script>
import Left from '../components/Leftt.vue';
